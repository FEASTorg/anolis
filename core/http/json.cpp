...
std::string quality_to_string(anolis::deviceprovider::v0::SignalValue_Quality quality) {
    ...
    switch (quality) {
        case Q::SignalValue_Quality_QUALITY_OK: return "OK";
        case Q::SignalValue_Quality_QUALITY_STALE: return "STALE";
        case Q::SignalValue_Quality_QUALITY_UNKNOWN: return "UNAVAILABLE";
        case Q::SignalValue_Quality_QUALITY_FAULT: return "FAULT";
...
std::string value_type_to_string(anolis::deviceprovider::v0::ValueType type) {
    ...
    switch (type) {
        case VT::VALUE_TYPE_DOUBLE: return "double";
        case VT::VALUE_TYPE_INT64: return "int64";
        case VT::VALUE_TYPE_UINT64: return "uint64";
        case VT::VALUE_TYPE_BOOL: return "bool";
        case VT::VALUE_TYPE_STRING: return "string";
        case VT::VALUE_TYPE_BYTES: return "bytes";
...
nlohmann::json encode_signal_value(const state::CachedSignalValue& cached, const std::string& signal_id) {
    ...
    auto timestamp_ms = std::chrono::duration_cast<std::chrono::milliseconds>(
        cached.timestamp.time_since_epoch()).count();
...
nlohmann::json encode_signal_spec(const registry::SignalSpec& spec) {
    ...
    return {
        ...
        {"value_type", value_type_to_string(spec.type)},
        {"label", spec.label}
    };
}

...
static bool has_port(const BT::PortsList& ports, const std::string& key) {
...
int main() {
    try {
        ...
        if (!has_port(call_ports, "device_handle") || !has_port(call_ports, "function_name") || !has_port(call_ports, "arg_target")) {

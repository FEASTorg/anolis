...
- After manual validation, proceed with hardware integration (Phase 16+)
- Use scenario runner for regression testing during development
- Reference this guide for training new operators

For automated testing, see: `tests/scenarios/README.md`
